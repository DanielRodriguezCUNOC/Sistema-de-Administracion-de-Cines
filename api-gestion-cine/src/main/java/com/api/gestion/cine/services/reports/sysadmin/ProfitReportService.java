...
public class ProfitReportService {
    ...
    public ProfitReportResponseDTO generateProfitReport(String fechaInicio, String fechaFin) {
        ...
        CinemaCostReport[] costoCinema = {
                new CinemaCostReport(1, "Cine Central", new int[] { 5000, 3000, 2000 }),
                new CinemaCostReport(2, "Cine Norte", new int[] { 4000, 2500 }),
                new CinemaCostReport(3, "Cine Sur", new int[] { 6000, 3500, 1500 })
        };
        ...
        return new ProfitReportResponseDTO(costoCinema, advertisementPayments, adBlockPayments);
    }
